...
### Requirement: TKT-017 ticket_history 表定义
...
### Requirement: TKT-018 状态变更写入 History
...
### Requirement: TKT-019 GET /api/tickets/:id/history
...
### Requirement: TKT-020 TicketHistoryEvent 共享类型
