...
describe('Integration: full ticket lifecycle', () => {
  ...
  beforeEach(async () => {
    ...
    await seedUser('u-int-00000000-0000-0000-000000000001', 'submitter', 'Integration Submitter', 'submitter', 'testpass')
    await seedUser('u-int-00000000-0000-0000-000000000002', 'dispatcher', 'Integration Dispatcher', 'dispatcher', 'testpass')
    await seedUser('u-int-00000000-0000-0000-000000000003', 'completer', 'Integration Completer', 'completer', 'testpass')
